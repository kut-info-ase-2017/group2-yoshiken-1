...
# memo     : 天候情報を学習・識別率算出,学習モデルをシリアライズ
# algorithm: MLP, LinerRegression, NeuralNetworkRegression
#            RandomForestRegression LogisticRegression
# ---------------------------------------------------------------------
...
def MLPC(x_train, y_train, x_test, y_test):
    #オブジェクト生成
    clf = MLPClassifier(hidden_layer_sizes=(500, 100), random_state=1)
